...
const ca: Translations = {
  ...
  voiceNotSupported:
    "El micròfon necessita una connexió segura (HTTPS) o localhost.",
  voiceQuota:
    "S'ha arribat al límit diari de l'IA. Torna-ho a provar més tard.",
  ...
  preferencesPlaceholder:
    "Som un parell vegà, ens agrada l'art underground i la techno…",
  ...
  noOffersYetSub:
    "Torna al cercador i prem «Generar viatge» per buscar vols i hotels.",
  flightsLabel: "Vols",
  hotelsLabel: "Hotels",
  ...
  towardsCity: (n, city) =>
    `Cap a ${city} · ${n} ${n === 1 ? "viatger" : "viatgers"}`,
  ...
  noRecommendationsSub:
    "Quan altres usuaris comparteixin viatges, apareixeran aquí",
...
const es: Translations = {
  ...
  voiceNotSupported:
    "El micrófono necesita una conexión segura (HTTPS) o localhost.",
  voiceQuota:
    "Se alcanzó el límite diario de la IA. Inténtalo de nuevo más tarde.",
  ...
  preferencesPlaceholder:
    "Somos veganos, nos gusta el arte underground y la techno…",
  ...
  favoritesHint:
    "Marca viajes como favoritos tocando el corazón en cualquier viaje.",
  startFirstTripHint:
    "Configura tu destino y deja que la IA construya el plan perfecto.",
  ...
  noOffersYetSub:
    "Vuelve al buscador y pulsa «Generar viaje» para buscar vuelos y hoteles.",
  flightsLabel: "Vuelos",
  hotelsLabel: "Hoteles",
  ...
  towardsCity: (n, city) =>
    `Hacia ${city} · ${n} ${n === 1 ? "viajero" : "viajeros"}`,
  ...
  dragActivitiesHint:
    "Arrastra las actividades para reordenarlas o moverlas a otro día.",
  ...
  noRecommendationsSub:
    "Cuando otros usuarios compartan viajes, aparecerán aquí",
...
const en: Translations = {
  ...
  startFirstTripHint:
    "Set up your destination and let AI build the perfect plan.",
  ...
  noOffersYetSub:
    "Go back to search and press «Generate trip» to search for flights and hotels.",
  ...
  towardsCity: (n, city) =>
    `To ${city} · ${n} ${n === 1 ? "traveler" : "travelers"}`,
...
const de: Translations = {
  ...
  configureTrip:
    "Planen Sie Ihre Reise und lassen Sie die KI den Rest erledigen.",
  ...
  voiceNotSupported:
    "Das Mikrofon benötigt eine sichere Verbindung (HTTPS) oder localhost.",
  ...
  preferencesPlaceholder:
    "Wir leben vegan, lieben Underground-Kunst und Techno…",
  ...
  favoritesHint:
    "Markieren Sie Reisen als Favoriten, indem Sie auf das Herzsymbol tippen.",
  startFirstTripHint:
    "Geben Sie ein Ziel ein und lassen Sie die KI den perfekten Plan erstellen.",
  ...
  noOffersYetSub:
    "Gehen Sie zurück und klicken Sie auf «Reise erstellen», um Flüge und Hotels zu suchen.",
  flightsLabel: "Flüge",
  hotelsLabel: "Hotels",
  ...
  notBookedYetSub:
    "Noch nicht gebucht? Sichern Sie sich jetzt Flüge und Unterkünfte.",
  ...
  towardsCity: (n, city) =>
    `nach ${city} · ${n} ${n === 1 ? "Reisender" : "Reisende"}`,
  ...
  dragActivitiesHint:
    "Ziehen Sie Aktivitäten, um sie neu anzuordnen oder auf einen anderen Tag zu verschieben.",
  ...
  noRecommendationsSub:
    "Wenn andere Benutzer Reisen teilen, erscheinen sie hier",
...
const fr: Translations = {
  ...
  voiceNotSupported:
    "Le micro nécessite une connexion sécurisée (HTTPS) ou localhost.",
  ...
  preferencesPlaceholder:
    "Nous sommes végétaliens, aimons l'art underground et la techno…",
  ...
  favoritesHint:
    "Marquez les voyages como favoris en appuyant sur le cœur sur n'importe quel voyage.",
  startFirstTripHint:
    "Configurez votre destination et laissez l'IA construire le plan parfait.",
  ...
  noOffersYetSub:
    "Retournez à la recherche et appuyez sur « Générer le voyage » pour rechercher des vols et hôtels.",
  flightsLabel: "Vols",
  hotelsLabel: "Hôtels",
  ...
  notBookedYetSub:
    "Pas encore réservé ? Sécurisez vos vols et hébergements maintenant.",
  ...
  towardsCity: (n, city) =>
    `Vers ${city} · ${n} ${n === 1 ? "voyageur" : "voyageurs"}`,
  ...
  dragActivitiesHint:
    "Faites glisser les activités pour les réordonner ou les déplacer vers un autre jour.",
  ...
  noRecommendationsSub:
    "Quand d'autres utilisateurs partageront leurs voyages, ils apparaîtront ici",
  ...
  cantShareCommunityTrip:
    "Les voyages communautaires ne peuvent pas être partagés à nouveau",
...
const it: Translations = {
  ...
  preferencesPlaceholder:
    "Siamo vegani, amiamo l'arte underground e la techno…",
  ...
  favoritesHint:
    "Salva i viaggi nei preferiti premendo il cuore su qualsiasi viaggio.",
  startFirstTripHint:
    "Configura la tua destinazione e lascia che l'IA costruisca il piano perfetto.",
  ...
  noOffersYetSub:
    "Torna alla ricerca e premi «Generar viatge» per cercare voli e hotel.",
  flightsLabel: "Voli",
  hotelsLabel: "Hotel",
  ...
  towardsCity: (n, city) =>
    `Verso ${city} · ${n} ${n === 1 ? "viaggiatore" : "viaggiatori"}`,
  ...
  dragActivitiesHint:
    "Trascina le attività per riordinarle o spostarle in un altro giorno.",
  ...
  noRecommendationsSub:
    "Quando altri utenti condivideranno i loro viaggi, appariranno qui",
  ...
  cantShareCommunityTrip:
    "I viaggi della comunità non possono essere ricondivisi",
  payNow: "Paga ora",
...
const pt: Translations = {
  ...
  voiceNotSupported:
    "O microfone precisa de uma conexão segura (HTTPS) ou localhost.",
  ...
  preferencesPlaceholder:
    "Somos veganos, gostamos de arte underground e techno…",
  ...
  favoritesHint:
    "Marque viagens como favoritas tocando no coração de qualquer viagem.",
  startFirstTripHint:
    "Configure o destino e deixe a IA construir o roteiro ideal.",
  ...
  noOffersYetSub:
    "Volte para a busca e clique em «Generar viatge» para buscar voos e hotéis.",
  flightsLabel: "Voos",
  hotelsLabel: "Hotéis",
  ...
  towardsCity: (n, city) =>
    `Para ${city} · ${n} ${n === 1 ? "viajante" : "viajantes"}`,
  ...
  dragActivitiesHint:
    "Arraste as atividades para as reordenar ou mover para outro dia.",
  savingText: "Salvando…",
  saveText: "Salvar",
  ...
  noRecommendationsSub:
    "Quando outros usuários compartilharem viagens, elas aparecerão aqui",
  ...
  cantShareCommunityTrip:
    "Viagens da comunidade não podem ser compartilhadas novamente",
  payNow: "Pagar agora",
  bookedWord: "Reservado",
...
const ar: Translations = {
  ...
  voiceQuota:
    "تم الوصول إلى الحد اليومي للذكاء الاصطناعي. حاول مرة أخرى لاحقاً.",
  ...
  noOffersYetSub:
    "ارجع إلى صفحة البحث وانقر على «إنشاء رحلة» للبحث عن الرحلات والفنادق.",
  ...
  towardsCity: (n, city) =>
    `باتجاه ${city} · لـ ${n} ${n === 1 ? "مسافر" : "مسافرين"}`,
...
const hi: Translations = {
  ...
  voiceIdleExample:
    "जैसे: «जून में 4 दिनों के लिए रोम की यात्रा, बजट 800 यूरो»",
  ...
  voiceNotSupported:
    "माइक्रोफ़ोन के लिए सुरक्षित कनेक्शन (HTTPS) या localhost ज़रूरी है।",
  ...
  favoritesHint:
    "किसी भी यात्रा पर दिल के निशान को दबाकर उसे पसंदीदा सूची में सहेजें।",
  startFirstTripHint:
    "अपना गंतव्य निर्धारित करें और AI को सही योजना बनाने दें।",
  ...
  noOffersYetSub:
    "पीछे जाएं और उड़ानें तथा होटल खोजने के लिए «यात्रा बनाएं» दबाएं।",
  ...
  towardsCity: (n, city) =>
    `${n} ${n === 1 ? "व्यक्ति" : "लोगों"} के लिए ${city} की ओर`,
  ...
  dragActivitiesHint:
    "गतिविधियों को पुनर्व्यवस्थित करने या दूसरे दिन स्थानांतरित करने के लिए उन्हें खींचें।",
  ...
  noRecommendationsSub:
    "जब अन्य उपयोगकर्ता यात्राएं साझा करेंगे, तो वे यहां दिखाई देंगी",
...
export function readLocale(): Locale {
  ...
  try {
    const match = document.cookie.match(
      /pl-lang=(ca|es|en|de|fr|it|pt|ar|zh|hi)/,
    );
...
export function localizeCity(cityId: string, locale: Locale): string {
  ...
  const canonicalId =
    CITY_VARIANT_MAP[norm] ??
    CITY_VARIANT_MAP_NORM[stripDiacritics(norm)] ??
    norm;
